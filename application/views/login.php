...
<head>
	...
	<!-- App Favicon -->
	<link rel="shortcut icon" href="<?= base_url('Dark') ?>/assets/images/favicon.ico">

	<!-- App title -->
	<title>Tapshop</title>
	<link href="<?= base_url('Dark') ?>/assets/css/menu.css" rel="stylesheet" type="text/css" />
							...
							<div class="col-lg-12">
								<div class="p-5">
									...
									<div class="text-center">
										<a class="logo"><span>Tap<span>Shop</span></span></a>
										<h5 class="text-muted m-t-0 font-600">Responsive Kasir POS Dashboard</h5>
									</div>
