									...
									<form action="<?= base_url('barang/proses_ubah/' . $barang->kode_barang) ?>" id="form-tambah" method="POST">
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												<input type="text" name="nama_supplier" placeholder="Masukkan Nama Supplier" autocomplete="off" class="form-control" required value="<?= $barang->nama_supplier ?>">
											</div>
											<div class="form-group col-md-6">
										...
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												...
												<select name="satuan" id="satuan" class="form-control" required>
													...
													<option value="pak" <?= $barang->satuan == 'pak' ? 'selected' : '' ?>>PACK</option>
